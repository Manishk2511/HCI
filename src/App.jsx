    ...
    <>
      ...
      <div className="bg-gray-800 h-screen p-3">
        ...
        >
            ...
            <h1 className="text-3xl text-center">Multi-lingual
Speech Bot</h1>
        ...
        <div className="w-full md:w-2/3 m-auto text-center rounded bg-gray-50 my-1">
          ...
          <button className="bg-red-300 rounded-3xl p-2 m-2 hover:bg-red-100" onClick={() => !isAudioOn &&  text_to_audio_hindi(answer)}>Hindi Speaking</button>
